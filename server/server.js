...
const allowedOrigins = [
  ...
  "https://b2bsitesibitmis.onrender.com",
  "https://curkuslar.online",
  "https://www.curkuslar.online",
];
...
const apiLimiter = rateLimit({
  ...
  legacyHeaders: false,
  message: {
    msg: "Çok fazla istek yaptınız, lütfen 15 dakika sonra tekrar deneyin.",
  },
});
...
safeMount("./routes/productionOrders", "/api/production-orders");
...
console.log(
  `Kullanılan PORT değişkeni: ${process.env.PORT || "3000 (varsayılan)"}`
);

app.listen(PORT, "0.0.0.0", () => {
  console.log(
    `Sunucu ${PORT} portunda 0.0.0.0 adresinde çalışıyor (Render için).`
  );
